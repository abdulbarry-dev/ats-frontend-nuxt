    ...
    <div class="container mx-auto px-4 max-w-7xl">
      ...
      <div class="mb-8 fade-in-up">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
          <div>
            <h1 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">Manage Jobs</h1>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
          <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-200 hover:shadow-md transition-shadow fade-in-up" style="animation-delay: 100ms;">
          ...
          <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-200 hover:shadow-md transition-shadow fade-in-up" style="animation-delay: 150ms;">
            <div class="flex items-center justify-between">
              <div>
          ...
          <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-200 hover:shadow-md transition-shadow fade-in-up" style="animation-delay: 200ms;">
            <div class="flex items-center justify-between">
              <div>
              ...
              <div class="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center">
                <Icon name="mdi:file-document-edit" class="w-6 h-6 text-orange-600" />
              </div>
            </div>
          </div>

          <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-200 hover:shadow-md transition-shadow fade-in-up" style="animation-delay: 250ms;">
            <div class="flex items-center justify-between">
              <div>
      ...
      <div class="mb-6 fade-in-up" style="animation-delay: 300ms;">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
          <div class="flex flex-col sm:flex-row gap-4">
            ...
            <!-- Filter by Status -->
            <select class="px-4 py-2.5 border border-gray-300 rounded-lg focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500 transition-all outline-none bg-white cursor-pointer">
        ...
        >
          <div class="p-6">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <div class="flex flex-wrap items-center gap-6">
                      <div class="flex items-center gap-2">
                        <div class="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center">
                          <Icon name="mdi:account-multiple" class="w-4 h-4 text-blue-600" />
                        </div>
                        <div>
                          <p class="text-xs text-gray-500">Applicants</p>
                          <p class="text-sm font-bold text-gray-900">{{ job.applicants }}</p>
                        </div>
                      </div>

                      <div class="flex items-center gap-2">
                        <div class="w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center">
                          <Icon name="mdi:eye" class="w-4 h-4 text-purple-600" />
                        </div>
                        <div>
                          <p class="text-xs text-gray-500">Views</p>
                          <p class="text-sm font-bold text-gray-900">{{ job.views }}</p>
                        </div>
                      </div>

                      <div class="flex items-center gap-2">
                        <div class="w-8 h-8 bg-orange-100 rounded-lg flex items-center justify-center">
                          <Icon name="mdi:star" class="w-4 h-4 text-orange-600" />
                        </div>
                        <div>
                          <p class="text-xs text-gray-500">Shortlisted</p>
                          <p class="text-sm font-bold text-gray-900">{{ job.shortlisted }}</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="flex lg:flex-col gap-2 lg:items-end">
                <button class="flex-1 lg:flex-initial px-4 py-2 bg-emerald-50 text-emerald-700 rounded-lg font-medium hover:bg-emerald-100 transition-colors flex items-center justify-center gap-2">
                  <Icon name="mdi:eye" class="w-4 h-4" />
                  <span class="hidden sm:inline">View</span>
                </button>
                <button class="flex-1 lg:flex-initial px-4 py-2 bg-blue-50 text-blue-700 rounded-lg font-medium hover:bg-blue-100 transition-colors flex items-center justify-center gap-2">
                  <Icon name="mdi:pencil" class="w-4 h-4" />
                  <span class="hidden sm:inline">Edit</span>
                </button>
                <button class="flex-1 lg:flex-initial px-4 py-2 bg-gray-50 text-gray-700 rounded-lg font-medium hover:bg-gray-100 transition-colors flex items-center justify-center gap-2">
          ...
          <div v-if="job.status === 'Active'" class="px-6 pb-4">
            <div class="flex items-center justify-between text-xs text-gray-600 mb-2">
              ...
              <span>{{ Math.round((job.applicants / job.targetApplicants) * 100) }}%</span>
            </div>
      ...
      <!-- Empty State -->
      <div v-if="jobs.length === 0" class="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center fade-in-up">
        ...
        <p class="text-gray-600 mb-6">Start by creating your first job posting</p>
        <NuxtLink 
          to="/jobs/post" 
      ...
      <!-- Pagination -->
      <div v-if="jobs.length > 0" class="mt-8 flex items-center justify-center gap-2 fade-in-up">
