    ...
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8 fade-in-up" style="animation-delay: 50ms;">
        ...
        <div class="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
          <Icon name="mdi:lock-reset" class="w-8 h-8 text-emerald-600" />
        </div>
      ...
      <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 fade-in-up" style="animation-delay: 150ms;">
        <form @submit.prevent="handleForgotPassword" class="space-y-5">
          ...
          <div class="input-group">
            ...
            <p class="text-xs text-gray-500 mt-1.5">We'll send a password reset link to this email</p>
          </div>
          ...
          >
            <Icon name="mdi:email-fast" class="w-5 h-5" />
            Send Reset Link
          </button>
        </form>
      ...
      <!-- Help Text -->
      <div class="mt-6 text-center fade-in-up" style="animation-delay: 250ms;">
        <p class="text-sm text-gray-500">
          Need help? <a href="mailto:support@findpoint.com" class="text-emerald-600 hover:text-emerald-700 font-medium">Contact Support</a>
        </p>
      </div>
    </div>
  </div>
...
useSeoMeta({
  title: 'Forgot Password - FindPoint',
  description: 'Reset your FindPoint account password'
})
