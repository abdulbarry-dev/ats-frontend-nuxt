    ...
    <div class="max-w-md w-full">
      ...
      <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 fade-in-up" style="animation-delay: 150ms;">
          ...
          <div class="flex items-center justify-between text-sm">
            <label class="flex items-center gap-2 cursor-pointer group">
              <input 
                type="checkbox" 
                v-model="rememberMe"
                class="w-4 h-4 rounded border-gray-300 text-emerald-600 focus:ring-2 focus:ring-emerald-500 focus:ring-offset-0 transition-colors"
              >
        ...
        <div class="relative my-6">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-4 bg-white text-gray-500">New to FindPoint?</span>
          </div>
        </div>
        ...
        <NuxtLink 
          to="/auth/register" 
          class="w-full px-6 py-3.5 border-2 border-emerald-600 text-emerald-600 rounded-xl font-semibold hover:bg-emerald-50 transition-all duration-300 flex items-center justify-center gap-2"
        >
      ...
      <!-- Footer -->
      <p class="mt-6 text-center text-sm text-gray-500 fade-in-up" style="animation-delay: 250ms;">
        By signing in, you agree to our 
        <NuxtLink to="/terms" class="text-emerald-600 hover:text-emerald-700 font-medium">Terms</NuxtLink> and 
...
useSeoMeta({
  ...
  description: 'Sign in to your FindPoint account to manage your job search and applications'
})
