        ...
        <form @submit.prevent="handleRegister" class="space-y-5">
            ...
            <div class="grid grid-cols-2 gap-3">
              <button
                ...
                :class="[
                  ...
                  userType === 'candidate'
                    ? 'border-emerald-600 dark:border-emerald-500 bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400'
                    : 'border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-700 dark:text-gray-200 hover:border-gray-300 dark:hover:border-slate-500',
                ]"
              >
          ...
          <label class="flex items-start gap-2.5 cursor-pointer group">
            <input
              ...
              v-model="acceptTerms"
              required
              class="mt-0.5 w-4 h-4 rounded border-gray-300 dark:border-slate-600 dark:bg-slate-700 text-emerald-600 focus:ring-2 focus:ring-emerald-500 focus:ring-offset-0 transition-colors"
            />
            <span
...
useSeoMeta({
  ...
  description:
    "Create your FindPoint account and start your job search journey",
});
