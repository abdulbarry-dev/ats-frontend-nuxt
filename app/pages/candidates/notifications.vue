                      ...
                      <div class="flex-1">
                        <h3
                          :class="[
                            ...
                            !notification.read && 'text-emerald-900',
                          ]"
                        >
                          {{ notification.title }}
                        </h3>
...
const currentFilter = ref<"all" | "unread" | "applications" | "interviews">(
  "all",
);
...
const notifications = ref<Notification[]>([
  {
    ...
    message:
      "Your interview with TechCorp Inc. for Senior Full Stack Developer position has been confirmed for tomorrow at 2:00 PM.",
    time: "2h ago",
    read: false,
    category: "today",
    actions: [
  ...
  },
  {
    ...
    message:
      "Your application for Frontend Engineer at StartupXYZ is now under review. The hiring team will contact you soon.",
    time: "5h ago",
    read: false,
    category: "today",
  ...
  },
  {
    ...
    message:
      "Sarah Johnson from Digital Solutions has sent you a message regarding your application.",
    time: "6h ago",
    read: false,
    category: "today",
    actions: [{ label: "Read Message", primary: true }],
  },
  {
    id: 4,
    type: "application",
    ...
    message:
      "InnovateTech has received your application for Lead Full Stack Engineer position. You'll hear back within 5-7 business days.",
    time: "Yesterday",
    read: true,
    category: "earlier",
  ...
  },
  {
    ...
    message:
      "It's been a while since you updated your profile. Keep it fresh to attract more opportunities!",
    time: "2 days ago",
    read: true,
    category: "earlier",
    actions: [{ label: "Update Profile", primary: true }],
  },
  {
    id: 6,
    type: "system",
    ...
    message:
      "We found 5 new jobs that match your profile and preferences. Check them out!",
    time: "3 days ago",
    read: true,
    category: "earlier",
    actions: [{ label: "View Jobs", primary: true }],
  },
  {
    id: 7,
    type: "interview",
    ...
    message:
      "CloudSystems has provided feedback on your interview. Login to view the details.",
    time: "4 days ago",
    read: true,
    category: "earlier",
  ...
  },
  {
    ...
    message:
      "Your application for React Developer at Digital Solutions has moved to the next stage.",
    time: "5 days ago",
    read: true,
    category: "earlier",
...
const getNotificationIconClass = (type: string) => {
  ...
  return (
    classes[type] || "bg-gradient-to-br from-gray-100 to-gray-200 text-gray-600"
  );
};
...
useHead({
  ...
  meta: [{ name: "description", content: "Your notifications on FindPoint" }],
});
</script>
