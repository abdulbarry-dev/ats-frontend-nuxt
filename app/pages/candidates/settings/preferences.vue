          ...
          <div>
            ...
            <div class="relative">
              ...
              <input
                ...
                type="number"
                placeholder="50,000"
                class="w-full pl-8 pr-4 py-3 border border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white dark:placeholder:text-gray-400 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-400 transition-colors duration-300"
              />
            </div>
          </div>
          <div>
