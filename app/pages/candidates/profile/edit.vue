    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <form @submit.prevent="saveProfile" class="max-w-4xl">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
          <div class="flex items-center gap-3 mb-6">
            <div class="w-10 h-10 bg-emerald-100 rounded-lg flex items-center justify-center">
              <Icon name="mdi:account" class="w-6 h-6 text-emerald-600" />
            </div>
          ...
          <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
              ...
              <div class="flex items-center gap-6">
                <div class="w-24 h-24 rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center overflow-hidden">
                  <img 
                    v-if="form.avatar" 
                    :src="form.avatar" 
                    alt="Avatar"
                  ...
                  />
                  <Icon v-else name="mdi:account" class="w-16 h-16 text-white" />
                </div>
                <div>
                  <button 
                    type="button"
            ...
            <div>
              ...
              <input 
                ...
                type="text"
                required
                class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
            ...
            <!-- Bio -->
            <div class="md:col-span-2">
              <label for="bio" class="block text-sm font-semibold text-gray-700 mb-2">Professional Summary *</label>
              <textarea 
                id="bio"
                v-model="form.bio"
                required
                rows="4"
                class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all resize-none"
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
          <div class="flex items-center gap-3 mb-6">
            <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
              <Icon name="mdi:link-variant" class="w-6 h-6 text-blue-600" />
            </div>
          ...
          <div class="grid md:grid-cols-2 gap-6">
            ...
            <div>
              <label for="github" class="block text-sm font-semibold text-gray-700 mb-2">
              ...
              <input 
                ...
                type="url"
                class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-all"
                placeholder="https://github.com/username"
              />
            </div>

            <div class="md:col-span-2">
              <label for="portfolio" class="block text-sm font-semibold text-gray-700 mb-2">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
          ...
          <div class="grid md:grid-cols-2 gap-3">
            <div 
              ...
              :key="index"
              class="flex items-center gap-3 p-3 bg-gradient-to-r from-purple-50 to-purple-100/50 rounded-lg border border-purple-200 group hover:from-purple-100 hover:to-purple-200/50 transition-all duration-300"
            >
              <input 
                v-model="skill.name"
                type="text"
                placeholder="Skill name (e.g., JavaScript)"
                class="flex-1 px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white text-sm"
              />
              <button 
                type="button"
          ...
          <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center">
                <Icon name="mdi:translate" class="w-6 h-6 text-orange-600" />
              </div>
        ...
        <div class="flex items-center gap-4">
          ...
          <NuxtLink 
            to="/candidates/profile"
            class="px-8 py-3 bg-white border-2 border-gray-200 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 transition-all duration-300 flex items-center gap-2"
          >
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Edit your candidate profile on FindPoint' }
  ]
})
</script>
