  ...
  >
    <div class="container mx-auto px-4 max-w-5xl">
        ...
        >
          ...
          <div class="flex gap-2 overflow-x-auto pb-2 sm:pb-0">
            <button
              ...
              "
              class="px-4 py-2 rounded-lg font-medium transition-all whitespace-nowrap flex items-center gap-2 duration-300"
            >
              ...
              <span
                ...
                :class="
                  activeTab === tab.id
                    ...
                    : 'bg-emerald-600 dark:bg-emerald-500 text-white'
                "
                class="px-2 py-0.5 rounded-full text-xs font-semibold transition-colors duration-300"
              >
                {{ tab.count }}
              </span>
            </button>
          ...
          <div class="flex items-center gap-2">
            <button
              v-if="unreadCount > 0"
              @click="markAllAsRead"
              class="px-4 py-2 text-sm font-medium text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 rounded-lg transition-colors flex items-center gap-2 duration-300"
            >
            ...
            <button
              ...
              class="p-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-slate-700 rounded-lg transition-colors duration-300"
      ...
      <Transition name="slide-fade">
        <div
          v-if="showSettings"
          class="bg-white dark:bg-slate-800 rounded-xl shadow-sm dark:shadow-slate-900/50 border border-gray-200 dark:border-slate-700 p-6 mb-6 fade-in-up transition-colors duration-300"
        >
          ...
          <div class="grid sm:grid-cols-2 gap-4">
            <div
              ...
              :key="pref.id"
              class="flex items-center justify-between p-3 bg-gray-50 dark:bg-slate-700/50 rounded-lg transition-colors duration-300"
            >
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p
                    class="font-medium text-gray-900 dark:text-white text-sm transition-colors duration-300"
                  >
                    {{ pref.label }}
                  </p>
                  <p
              ...
              <label class="relative inline-flex items-center cursor-pointer">
                ...
                />
                <div
                  class="w-11 h-6 bg-gray-300 dark:bg-slate-600 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-emerald-300 dark:peer-focus:ring-emerald-800 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-600 dark:peer-checked:bg-emerald-500 transition-colors duration-300"
                ></div>
              </label>
            </div>
          </div>
      ...
      <div class="space-y-3">
        ...
        <div
          ...
          :key="notification.id"
          :class="[
            'bg-white dark:bg-slate-800 rounded-xl shadow-sm dark:shadow-slate-900/50 border transition-all duration-300 overflow-hidden group fade-in-up cursor-pointer',
            notification.read
              ? 'border-gray-200 dark:border-slate-700 hover:shadow-md dark:hover:shadow-slate-900/80'
              : 'border-emerald-200 dark:border-emerald-800/50 bg-emerald-50/30 dark:bg-emerald-900/10 hover:shadow-lg dark:hover:shadow-slate-900/80',
          ]"
        ...
        >
          <div class="p-4 sm:p-5 flex gap-4">
            ...
            <div class="flex-1 min-w-0">
              <div class="flex items-start justify-between gap-4 mb-2">
                ...
                <button
                  ...
                  class="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors p-1 duration-300"
              ...
              <!-- Meta Info -->
              <div
                class="flex flex-wrap items-center gap-3 text-xs text-gray-500 dark:text-gray-500 transition-colors duration-300"
              >
                ...
                <span
                  ...
                  :class="[
                    'px-2 py-1 rounded-md font-medium transition-colors duration-300',
            ...
            <div
              ...
              class="w-2 h-2 bg-emerald-600 dark:bg-emerald-400 rounded-full flex-shrink-0 mt-2 transition-colors duration-300"
            ></div>
          </div>
        </div>
      </div>
      ...
      <div v-if="hasMore" class="mt-6 text-center fade-in-up">
        <button
          @click="loadMore"
          :disabled="loading"
          class="px-6 py-3 bg-white dark:bg-slate-800 border-2 border-gray-300 dark:border-slate-600 text-gray-700 dark:text-gray-300 rounded-lg font-semibold hover:border-emerald-500 dark:hover:border-emerald-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-all disabled:opacity-50 disabled:cursor-not-allowed duration-300"
        >
...
const tabs = computed(() => [
  { id: "all", label: "All", icon: "mdi:bell", count: unreadCount.value },
  {
    ...
    label: "Jobs",
    icon: "mdi:briefcase",
    count: notifications.value.filter((n) => !n.read && n.type === "job")
      .length,
  },
  {
    id: "application",
  ...
  },
  {
    ...
    label: "Messages",
    icon: "mdi:message",
    count: notifications.value.filter((n) => !n.read && n.type === "message")
      .length,
  },
]);
...
const preferences = ref([
  ...
  },
  {
    ...
    description: "Following companies",
...
const notifications = ref<Notification[]>([
  {
    ...
    message:
      "Your application for Senior Frontend Engineer at TechCorp has been reviewed. The hiring team would like to schedule an interview.",
  ...
  },
  {
    ...
    title: "New Job Match",
    message:
      "We found a new job that matches your preferences: Product Designer at DesignHub. This position offers remote work and competitive salary.",
  ...
  },
  {
    ...
    message:
      "Sarah Johnson from Global Finance Group sent you a message regarding the Financial Analyst position.",
  ...
  },
  {
    ...
    message:
      "CloudSpace Systems has posted 3 new job openings that might interest you.",
  ...
  },
  {
    ...
    message:
      "Your application for DevOps Engineer at CloudSpace Systems has been received and is under review.",
  ...
  },
  {
    ...
    message:
      "Your profile has been viewed by 12 recruiters this week. Keep your profile updated to attract more opportunities!",
  ...
  },
  {
    ...
    message:
      "The application deadline for Backend Engineer at DataDrive Analytics is in 2 days. Don't miss out!",
  ...
  },
  {
    ...
    message:
      "Thank you for your interest in the Marketing Manager position at BrandBoost. While your qualifications are impressive, we've decided to move forward with other candidates.",
