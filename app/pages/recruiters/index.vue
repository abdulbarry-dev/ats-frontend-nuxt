  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
    <div class="container mx-auto px-4 max-w-7xl">
      ...
      <div class="grid lg:grid-cols-3 gap-6 mb-8">
        <!-- Recent Applications -->
        <div
          class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 p-6 fade-in-up"
        ...
        >
          ...
          <div class="space-y-4">
            ...
            >
              ...
              <button
                class="px-4 py-2 bg-emerald-50 text-emerald-700 rounded-lg text-sm font-medium hover:bg-emerald-100 transition-colors flex-shrink-0"
              >
                Review
              </button>
            </div>
        ...
        <div class="space-y-6">
          ...
          <!-- Quick Actions -->
          <div
            class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl border border-emerald-200 p-6 fade-in-up"
          ...
          >
            ...
            <div class="space-y-2">
              <NuxtLink
                to="/jobs/post"
                class="flex items-center gap-3 p-3 bg-white rounded-lg hover:shadow-md transition-all group"
              >
                <div
      ...
      <!-- Top Performing Jobs -->
      <div
        class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8 fade-in-up"
      ...
      >
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div
            ...
            :key="index"
            class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-all group"
          >
            ...
            <h3
              class="font-semibold text-gray-900 mb-2 group-hover:text-emerald-600 transition-colors"
            >
              {{ job.title }}
            </h3>
