    ...
    <div class="container mx-auto px-4 max-w-7xl">
      ...
      <div class="mb-8 fade-in-up">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <div>
            <h1 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">Candidates</h1>
            <p class="text-gray-600">Manage and review all your job applicants</p>
          </div>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
          ...
          <div class="bg-white rounded-lg p-4 border border-orange-200 hover:shadow-md transition-shadow">
            <p class="text-xs text-orange-600 mb-1">Interview</p>
            <p class="text-2xl font-bold text-orange-600">32</p>
          </div>
          <div class="bg-white rounded-lg p-4 border border-emerald-200 hover:shadow-md transition-shadow">
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6 fade-in-up" style="animation-delay: 100ms;">
        <div class="flex flex-col md:flex-row gap-4">
          ...
          <!-- Job Filter -->
          <select class="px-4 py-2.5 border border-gray-300 rounded-lg focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500 transition-all outline-none bg-white cursor-pointer min-w-[180px]">
          ...
          <!-- Status Filter -->
          <select class="px-4 py-2.5 border border-gray-300 rounded-lg focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500 transition-all outline-none bg-white cursor-pointer min-w-[150px]">
          ...
          <div class="flex gap-2 bg-gray-100 p-1 rounded-lg">
            ...
            <button class="px-3 py-2 text-gray-600 hover:bg-gray-200 rounded-md transition-colors">
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        >
          ...
          <div class="h-24 bg-gradient-to-r relative" :class="candidate.bgGradient">
            <div class="absolute -bottom-12 left-6">
              <div class="w-24 h-24 rounded-full border-4 border-white bg-gradient-to-br shadow-lg flex items-center justify-center text-white font-bold text-2xl overflow-hidden" :class="candidate.avatarGradient">
            ...
            <div class="absolute top-4 right-4 bg-white px-3 py-1 rounded-full shadow-md flex items-center gap-1">
              ...
              <span class="text-sm font-bold text-gray-900">{{ candidate.rating }}</span>
            </div>
          </div>
          ...
          <div class="pt-14 px-6 pb-6">
            ...
            <div class="mb-4">
              ...
              >
                <span class="w-1.5 h-1.5 rounded-full" :class="getStatusDotClass(candidate.status)"></span>
                {{ candidate.status }}
              </span>
            </div>
            ...
            <div class="grid grid-cols-3 gap-3 mb-4 pb-4 border-b border-gray-200">
              <div class="text-center">
                ...
                <p class="text-sm font-bold text-gray-900">{{ candidate.experience }}</p>
              </div>
              <div class="text-center border-x border-gray-200">
                <p class="text-xs text-gray-500 mb-1">Match</p>
                <p class="text-sm font-bold text-emerald-600">{{ candidate.match }}%</p>
              </div>
              <div class="text-center">
                <p class="text-xs text-gray-500 mb-1">Applied</p>
                <p class="text-sm font-bold text-gray-900">{{ candidate.appliedDays }}d</p>
              </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-2">
              <button class="px-4 py-2.5 bg-emerald-600 text-white rounded-lg font-medium hover:bg-emerald-700 transition-colors flex items-center justify-center gap-2">
                <Icon name="mdi:eye" class="w-4 h-4" />
                View
              </button>
              <button class="px-4 py-2.5 border-2 border-gray-300 text-gray-700 rounded-lg font-medium hover:border-emerald-500 hover:text-emerald-600 transition-colors flex items-center justify-center gap-2">
      ...
      <!-- Empty State -->
      <div v-if="candidates.length === 0" class="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center fade-in-up">
      ...
      <!-- Pagination -->
      <div v-if="candidates.length > 0" class="mt-8 flex items-center justify-center gap-2 fade-in-up">
        ...
        <button class="px-4 py-2 bg-emerald-600 text-white rounded-lg font-medium">1</button>
...
const candidates = ref([
  ...
  },
  {
    ...
    skills: ['User Research', 'Usability Testing', 'Data Analysis', 'Wireframing'],
