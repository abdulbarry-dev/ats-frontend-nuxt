    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 max-w-4xl">
      ...
      <div class="mb-8">
        ...
        <p class="text-gray-600 dark:text-gray-400">
          Choose how you want to be notified about recruiting activities
        </p>
      </div>
      ...
      >
        ...
        <div class="space-y-4">
          <div
            ...
            :key="notification.id"
            class="flex items-start justify-between py-4 border-b border-gray-100 dark:border-slate-700 last:border-0"
          >
            <div class="flex-1">
          ...
          <div>
            ...
            <div class="space-y-2">
              <label
                ...
                :key="option.value"
                class="flex items-center gap-3 p-3 border border-gray-200 dark:border-slate-600 rounded-xl hover:bg-gray-50 dark:hover:bg-slate-700 cursor-pointer transition-all"
              >
                <input
                  v-model="emailDigest"
                  type="radio"
...
const emailNotifications = ref([
  ...
  },
  {
    ...
    description: "When candidates match your search criteria",
    enabled: true,
  },
  {
    id: "interview-confirmations",
    title: "Interview Confirmations",
    description: "When candidates confirm or reschedule interviews",
    enabled: true,
  },
  {
    id: "messages",
    title: "Messages from Candidates",
  ...
  },
  {
    ...
    description: "Weekly summary of hiring activity and metrics",
    enabled: true,
  },
]);
...
const pushNotifications = ref([
  {
    id: "urgent-applications",
    title: "Urgent Applications",
    description: "High-priority candidate applications",
    enabled: true,
  },
  {
    id: "interview-alerts",
...
useSeoMeta({
  ...
  description: "Manage your recruiter notification preferences",
});
</script>
